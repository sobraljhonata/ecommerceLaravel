...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getClients: function getClients() {
      ...
      this.$axios.get('/oauth/clients').then(function (response) {
    ...
    persistClient: function persistClient(method, uri, form, modal) {
      ...
      form.errors = [];
      this.$axios[method](uri, form).then(function (response) {
        _this2.getClients();
    ...
    destroy: function destroy(client) {
      ...
      this.$axios["delete"]('/oauth/clients/' + client.id).then(function (response) {
        _this3.getClients();
      });
    }
  }
            ...
            _c("div", { staticClass: "modal-body" }, [
              _vm.createForm.errors.length > 0
                ? _c("div", { staticClass: "alert alert-danger" }, [
                    ...
                    _c(
                      "ul",
                      _vm._l(_vm.createForm.errors, function(error, index) {
            ...
            _c("div", { staticClass: "modal-body" }, [
              _vm.editForm.errors.length > 0
                ? _c("div", { staticClass: "alert alert-danger" }, [
                    ...
                    _c(
                      "ul",
                      _vm._l(_vm.editForm.errors, function(error, index) {
                        return _c("li", { key: index }, [
                          _vm._v(
                            "\n                                " +
                              _vm._s(error) +
